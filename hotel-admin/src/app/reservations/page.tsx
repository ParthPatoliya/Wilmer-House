...
import { Calendar as CalendarIcon, Filter, Plus, Search, ChevronLeft, ChevronRight, Download, Users, UserPlus, Check, X, Clock, AlertCircle } from 'lucide-react';
...
export default function ReservationsCalendarPage() {
    ...
    return (
        <div className="space-y-6 max-w-[1800px] mx-auto pb-10" onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp}>
            ...
            {/* Premium Full Month Calendar UI */}
